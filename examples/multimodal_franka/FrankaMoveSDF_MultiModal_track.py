...
class MPCRobotController(FrankaEnvBase):
    def __init__(self, gym_instance , ik_mSolve):
        ...
        self.update_collision_state([self.x - 0.30 ,0.60,-0.40])
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            try:
                ...
                # compute pointcloud to sdf_map 4.5ms | self.collision_grid 
                ...
                self._dynamic_object_moveDesign_leftright_track()
                self.traj_append()
