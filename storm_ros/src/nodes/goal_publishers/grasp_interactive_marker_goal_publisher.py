...
class InteractiveMarkerGoalPub():
    ...
    def update_ee_goal_to_current(self):
        ...
        rospy.loginfo("Position: x:%f y:%f z:%f", self.ee_goal.pose.position.x, self.ee_goal.pose.position.y, self.ee_goal.pose.position.z) 
        rospy.loginfo("Orientation: x:%f y:%f z:%f w:%f", 
                    self.ee_goal.pose.orientation.x, self.ee_goal.pose.orientation.y, self.ee_goal.pose.orientation.z, self.ee_goal.pose.orientation.w)
