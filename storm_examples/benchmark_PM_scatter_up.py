...
fieldnames =  ['whileloop_count', 'collision_count', 'crash_rate', 'path_length', 'Avg.Speed', 'Max.Speed', 'judge_coll_weight','note'] 
...
def run_experiment():
    ...
    with open('./SDFcostlog/enhanced_benchmark_PM_scatter_UP.csv', 'a', newline='') as f:
