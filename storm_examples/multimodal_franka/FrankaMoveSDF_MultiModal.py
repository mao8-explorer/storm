...
class MPCRobotController(FrankaEnvBase):
    def __init__(self, gym_instance , ik_mSolve):
        ...
        self.fieldnames = ['whole_time', 'opt_step_count', 'collison_count','oneLoop','oneOpt','Avg.Speed', 'Max.Speed','Mean_weight'] 
    ...
    def run(self):
        ...
        row = {'whole_time':time.time() - last, 'opt_step_count': opt_step_count, 'collison_count':self.curr_collision, 
               ...
               'Avg.Speed':avgvel, 'Max.Speed':maxvel, 'Mean_weight':mean_w}
        ...
        # with open('UPMultiModalFrankaPPV.pkl', 'wb') as f:
