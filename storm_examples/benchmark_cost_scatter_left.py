...
fieldnames =  ['running_time','whileloop_count', 'collision_count', 'crash_rate', 'path_length', 'Avg.Speed', 'Max.Speed', 
...
def run_experiment():
    ...
    with open('./SDFcostlog/version0101/enhanced_benchmark_cost_scatter_Left_PPV.csv', 'a', newline='') as f:
        ...
        with open('./SDFcostlog/version0101/enhanced_benchmark_cost_scatter_Left_PPV_meanstd.csv', 'a', newline='') as var_file:
